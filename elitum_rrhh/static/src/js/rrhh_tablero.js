odoo.define('rrhh_dashboard', function (require) {
    'use strict';

    var kanban_widgets_rrhh = require('web_kanban.widgets');

    var RrhhDashboardGraph = kanban_widgets_rrhh.AbstractField.extend({
        start: function() {
    ...
    kanban_widgets_rrhh.registry.add('dashboard_graph_rrhh', RrhhDashboardGraph);
